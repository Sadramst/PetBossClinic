          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-foreground/80">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+982122000000" className="hover:text-primary transition-colors dir-ltr">۰۲۱-۲۲۰۰۰۰۰۰</a>
              </li>
              <li className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="p-4 rounded-xl bg-surface-card border border-border text-sm space-y-2.5">
              <div className="flex justify-between items-center text-foreground">
                <span className="font-medium">همه روزه (شنبه تا جمعه):</span>
                <span className="text-primary font-bold">۱۰:۰۰ الی ۲۲:۰۰</span>
              </div>
              <p className="text-xs text-muted-foreground pt-2 border-t border-border/50">
                بخش اورژانس و پذیرش بدون تعطیلی در ساعات کاری فعال است.
              </p>
            </div>
          </div>
        </div>
